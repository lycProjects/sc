...
insert  into `sc_teammapping`(`tmm_id`,`tmm_name`) values (1,'青云技术服务工作室'),(2,'T-Group工作室'),(3,'网络安全攻防技术训练营'),(4,'服务器工作室'),(5,'ACM算法公关部'),(6,'向量工作室'),(7,'你猜工作室'),(8,'恒创VR工作室');
