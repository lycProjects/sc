...
MySQL - 5.1.65-community : Database - sc
*********************************************************************
*/
...
insert  into `sc_absence`(`ab_id`,`ab_name`,`ab_team`,`ab_time`) values (1,'王帅兵',2,3),(2,'刘继童',2,4),(3,'李勇超',2,3),(4,'石腾飞',2,1);
...
insert  into `sc_equip`(`id`,`eq_name`,`eq_unit`,`eq_amout`,`eq_note`) values (30,'Z400','台',10,'暂无'),(38,'Z200','台',50,'暂无'),(39,'显示屏','个',60,'暂无'),(43,'鼠标','个',60,'暂无'),(47,'键盘','个',60,'暂无'),(49,'照相机','个',2,'暂无'),(50,'打印机','台',1,'暂无'),(51,'1G(内存条)','个',30,'暂无'),(52,'2G(内存条)','个',30,'暂无'),(53,'插板','个',30,'暂无'),(54,'4G(内存条)','个',30,'暂无');
...
insert  into `sc_equipborrow`(`eqb_id`,`eqb_team`,`eqb_zfour`,`eqb_oneg`,`eqb_twog`,`eqb_fourg`) values (2,2,2,2,3,1),(5,5,2,2,0,0),(7,7,2,1,0,0),(28,6,2,2,2,1),(34,1,20,20,10,0),(35,3,10,10,10,1),(36,4,5,5,2,2),(37,8,1,1,1,0);
...
insert  into `sc_issusdproject`(`ip_id`,`en_id`,`ti_id`,`en_name`,`ip_projectname`,`ip_briefintroduction`,`en_projectstate`,`en_statename`,`en_issusdtime`,`en_projectover`) values (1,1,3,'青云','文古苑','一个为藏友们搭建藏品信息交流的网站平台',1,'等待团队申请','2018年10月20日 20:56:02',NULL),(2,1,4,'青云','野渡无人户外旗舰店','野渡无人户外平台是一个专注户外运动的店铺',1,'等待团队申请','2018年10月20日 20:59:33',NULL),(3,1,5,'青云','花瓣儿智能问答','花瓣儿网络科技有限公司成立于2015年，是一家基于财税专业服务应用场景，充分利用行业大数据和人工智能技术，致力于解决现实业务中实际问题的智能财税服务商。花瓣儿开发了系列的税务软件系统，并建立了专业服务网络平台，积聚了众多知名的、资深的财税专家，致力于为纳税人提供全生命周期、全品类维度、全过程保障的一站式财税服务。花瓣儿是智慧财税服务的缔造者，是传统财税服务的革新者，是广大企业茁壮成长的助推者。让更',1,'等待团队申请','2018年10月20日 21:01:38',NULL),(4,3,6,'达人达己','河南元森公司企业文化','21世纪是互联网快速发展的飞升阶段，公司文化，应当伴随互联网的脚步，走向全国，面向世界，打出自己民族的品牌，创造属于自己的天地，让别人了解公司的运营，同时也可以为公司招商带来极大地便利，赢取更多的合作伙伴，实现双赢。',1,'等待团队申请','2018年10月20日 21:02:48',NULL);
...
insert  into `sc_jlrule`(`jl_id`,`jl_team`,`jl_recode`,`jl_time`) values (1,6,'穿拖鞋','2018-03-21'),(2,7,'穿拖鞋','2018-08-29'),(3,6,'吃零食','2018-03-23'),(4,3,'462','2018-10-20');
...
insert  into `sc_student`(`st_id`,`st_team`,`st_number`,`st_name`,`st_sex`,`st_class`,`st_phone`,`st_IDcard`,`st_teacher`) values (1,2,161210128,'王帅兵','男','16计科一班','15036887638','412426199890789078','郑浩'),(2,2,161530254,'左丽萍','女','16计科二班','15933344423','12323653443577','郑浩'),(3,2,121912822,'李勇超','男','16游戏开发','12564978736','145761216786146','郑浩'),(4,2,161262665,'乔荣宁','男','16计科二班','15383838333','412772732737373','郑浩'),(5,2,167272373,'吴垚锖','女','16计科二班','16727272727','377873783783733','郑浩'),(6,2,161210137,'刘继童','男','16计科一班','15036894966','123425342783838','郑浩'),(7,2,161210165,'位营杰','女','16软工二班','17626526229','415448518514854','郑浩'),(8,2,162584848,'韩玉杰','女','16软工二班','17273283833','586896987393393','郑浩'),(9,2,172738383,'杨文静','女','17软工三班','17632537383','477578328383833','郑浩'),(10,2,175626262,'李金伟','女','17软工三班','17846262622','458732838383833','郑浩'),(11,1,163838332,'郭英铎','男','16计科一班','17387387378','533753783737837','李冰'),(12,1,142733733,'葛泽兵','男','16软工二班','15838373733','873873737373333','李冰'),(13,4,163837333,'赵意可','男','16计科一班','17282732733','427283285383833','李真'),(14,4,163838383,'梁一亮','男','17软工三班','17278373733','372752434534533','李真'),(15,4,172728277,'郭宁','男','16软工二班','17573833833','839535354354333','李真'),(16,3,152838383,'段艳艳','女','16计科一班','17283838383','424538383838383',NULL),(17,6,153838383,'郭栋','男','17软工三班','17262626262','427378383866763',NULL),(18,5,163838383,'张何','女','16软工二班','17273273273','427373583373733',NULL),(19,7,152838383,'王海','男','17软工三班','17926626622','422144626626262',NULL),(20,8,158626262,'赵云','男','16软工二班','17572838383','427387387368383',NULL);
...
insert  into `sc_teacher`(`te_id`,`te_name`,`te_unit`,`te_phone`,`te_position`,`te_IDcard`) values (14,'郑浩','T-Group工作室','15036859696','讲师','41212738645128722'),(15,'张礼坚','你猜工作室','15036859688','讲师','41212738645123876'),(16,'李真','服务器工作室','15036857171','讲师','32455121273864516'),(17,'李冰','青云工作室','15838328323','讲师','47234567654323212');
...
insert  into `sc_title`(`ti_id`,`ti_type`,`ti_mentionedabove`,`ti_auther`,`ti_autherid`,`ti_addressurl`,`ti_releasetime`) values (1,1,'发布公司','青云',1,'project1/demo','2018/9/25'),(2,2,'创作团队','T-Group',2,'project2/demo','2018/9/25'),(3,1,'发布公司','青云',0,'/DataFile/articles/20181020085602347502/index.html','2018年10月20日 20:56:02'),(4,1,'发布公司','青云',0,'/DataFile/articles/20181020085933655679/index.html','2018年10月20日 20:59:33'),(5,1,'发布公司','青云',0,'/DataFile/articles/20181020090138775995/index.html','2018年10月20日 21:01:38'),(6,1,'发布公司','达人达己',0,'/DataFile/articles/20181020090248305210/index.html','2018年10月20日 21:02:48');
...
insert  into `sc_wsrule`(`ws_id`,`ws_team`,`ws_recode`,`ws_time`) values (1,2,'未倒垃圾','2018-08-29'),(2,5,'地面不干净','2018-08-29'),(3,6,'未倒垃圾','2018-09-05'),(4,6,'地面不干净','2018-09-05'),(5,1,'','2018-09-24'),(6,1,'136162','2018-10-20');
