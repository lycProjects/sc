...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="postDelete(-1)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','admin-add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span>  </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="5">员工列表</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
		   <c:forEach items="${loginList }" var="ll">
			<tr class="text-c">
				<td><input type="checkbox" value="${ll.loId }" name="delete_form_ids"></td>
				<td>${ll.loUsername }</td>
				<td>${ll.loPassword }</td>
				<td>${ll.roles[0].role }</td>
				<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_add('编辑管理员','admin-add?loId=${ll.loId }','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'${ll.loId }')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
...
function postDelete(delIndex){
	...
	layer.confirm('确认要删除吗？',function(index){
		if(delIndex<0){//批量删除
			...
			$.ajax({
				type: 'POST',
				url: '${pageContext.request.contextPath}/admin-list/delete',
				data:{
					"loIds":idsString.substring(1)
				},
