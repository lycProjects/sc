...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/companyManager/add/addUp" method="Post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="enName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>公司简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="enBriefintroduction" cols="" rows="" class="textarea" placeholder="公司简介...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="enPhone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">招聘信息：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="enRecruitment" cols="" rows="" class="textarea" placeholder="招聘信息...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		<div class="row cl">
