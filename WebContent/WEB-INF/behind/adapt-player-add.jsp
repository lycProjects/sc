...
<div class="page-container">
	<form action="adaptadds" class="form form-horizontal" id="form-article-add" method="POST">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>学号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stNumber">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stName">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stClass">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stSex">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stPhone">
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>指导团队：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <input type="text" class="input-text" value="" placeholder="" id="" name=""> -->
				<input type="text" name="stTeam" id="teUnit-input">
				<select name="stTeam" class="input-text" id="teUnit-select">
                  <option value="">请选择团队</option>
                  <c:forEach items="${teammappingMappersList }" var="tm">
                     <option value="${tm.tmmId }">${tm.tmmName }</option>
                  </c:forEach>
                </select>
			</div> 
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>指导老师：</label> 
                <div class="formControls col-xs-8 col-sm-9">
				<!-- <input type="text" class="input-text" value="" placeholder="" id="" name=""> -->
				<input type="text" name="stTeacher" id="teUnitinput" class="input-text">
				<select name="stTeacher" class="input-text" id="teUnitselect">
                  <option value="">请选择指导老师</option>
                  <c:forEach items="${teacherList  }" var="tl">
                      <option value="${tl.teName }">${tl.teName }</option>
                  </c:forEach>
                </select>
			    </div> 
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="stIdcard">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
	var select1 = $("#teUnitselect");
	var input1 = $("#teUnitinput").hide();
	select1.change(function(){
		var option1=$("#teUnitselect option:selected");
		input1.attr("name",option1.val());
	});	
</script>
