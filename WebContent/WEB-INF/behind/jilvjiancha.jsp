					...
					<form class="form-horizontal" id="clean_form">
						...
						<div class="form-group">
							<label for="edit_time" style="font-size:16px;font-family:微软雅黑；">&nbsp&nbsp时  间&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
								<input type="text"  id="" value="<%=sdf.format(date)%>" name="jlTime" style="width:300px;height:31px;margin-left:20px;border-radius:5px;border:1px solid #000;">	
						</div>
						<br/><br/>
						
						<div class="form-group">
							<label for="edit_reson"  style="font-size:16px;font-family:微软雅黑；">&nbsp&nbsp违纪原因</label>
								<input type="text"  placeholder="  纪律检查" name="jlRecode" style="width:300px;height:30px;margin-left:20px;border-radius:5px;border:1px solid #000;">	
						</div>
						<br/><br/>
						...
						<div class="form-group" style="line-height:5px" >
							<label for="edit_teamId" id="teamId" style="font-size:16px;font-family:微软雅黑；">&nbsp&nbsp团队ID&nbsp&nbsp&nbsp</label>
								<input type="text"  id="edit_ti" placeholder="  团队ID" name="jlTeam" style="width:300px;height:30px;margin-left:20px;border-radius:5px;border:1px solid #000;">	
						</div>
					</form>
				</div>
...
function clean_insert() {
	$.post("discipline_insert",$("#clean_form").serialize(),function(data){
