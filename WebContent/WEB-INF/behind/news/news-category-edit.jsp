...
<div class="page-container">
	<form action="news-category-edit/edit" method="Post" class="form form-horizontal" id="form-article-add">
		<input type="hidden" value="${newsCategory.newscateId}" name="newscateId">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>类别名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${newsCategory.newscateTitle}" placeholder="" id="newscateTitle" name="newscateTitle">
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>类别显示：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select name="newscateMark" class="input-text Wdate">
					<c:if test="${newsCategory.newscateMark=='normal' }">
						<option value="normal" title="不会展示在首页的类别" selected="selected">列表显示</option>
						<option value="show_news_index" title="会展示在首页的类别">首页显示</option>
					</c:if>
					<c:if test="${newsCategory.newscateMark=='show_news_index' }">
						<option value="normal" title="不会展示在首页的类别">列表显示</option>
						<option value="show_news_index" title="会展示在首页的类别" selected="selected">首页显示</option>
					</c:if>
				</select>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">类别描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="newscateBrief" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${newsCategory.newscateBrief.trim() }</textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
