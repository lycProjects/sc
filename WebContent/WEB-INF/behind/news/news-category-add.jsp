...
<div class="page-container">
	<form action="news-category/add" method="POST" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>类别名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="newscateTitle" name="newscateTitle">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="newscateBrief" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
...
function article_save(){
	var newscateTitle=$('#newscateTitle').val();
	//alert(newscateTitle);
	if(newscateTitle!=null&newscateTitle!=''){
		return true;
	}else{
		//alert('类别名不能为空');
		return false;
