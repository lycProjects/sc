...
<body>
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="adapt-player2" data-title="成员调整"
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="weijihuizongbiao2" data-title="违纪汇总表"
						href="javascript:void(0)">违纪汇总</a></li>
					<li><a data-href="absence2" data-title="缺勤汇总表"
		...
		<dl id="menu-project">
			<dt>
				<i class="Hui-iconfont">&#xe62b;</i> 项目市场<i
					class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="team/projectShop" data-title="项目浏览"
						href="javascript:void(0)">项目浏览</a></li>
					<li><a data-href="team/projectApplying" data-title="申请的项目"
						href="javascript:void(0)">申请的项目</a></li>
				</ul>
			</dd>
		</dl>
	</div>
