...
<title>添加卫生检查情况</title>
<link href="lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form action="../studentedit" class="form form-horizontal" id="form-article-add" method="POST">
		<div class="row cl">
			<!-- <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>借用团队：</label> -->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${student.stId}" placeholder="" id="" name="stId">
			</div>
		</div>
		...
		<div class="row cl">
			<!-- <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>借用团队：</label> -->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${student.stTeam}" placeholder="" id="" name="stTeam">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stSex}" placeholder="" id="" name="stSex">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stIdcard}" placeholder="" id="" name="stIdcard">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stNumber}" placeholder="" id="" name="stNumber">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stName}" placeholder="" id="" name="stName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">班级：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stClass}" placeholder="" id="" name="stClass">
			</div>
		</div>
		<div class="row cl">
			<!-- <label class="form-label col-xs-4 col-sm-2">指导老师：</label> -->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${student.stTeacher}" placeholder="" id="" name="stTeacher">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">联系方式：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${student.stPhone}" placeholder="" id="" name="stPhone">
			</div>
		</div>
