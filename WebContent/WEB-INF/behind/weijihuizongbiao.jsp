...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 检索功能 <span class="c-gray en">&gt;</span> 违纪汇总表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">  
		...
		<a class="btn btn-primary radius" style="float: right;" href="javascript:;"> 附表</a>
	</div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		 <c:forEach items="${JlruleList }" var="Jlrule">
					<tr class="text-c">
					 <td><input name="ids" type="checkbox" value="${Jlrule.jlId}"></td>
					 <td>${Jlrule.teammapping[0].tmmName}</td>
					 <td>${Jlrule.jlRecode}</td>
					 <td><fmt:formatDate value="${Jlrule.jlTime}" pattern="yyyy-MM-dd"/></td>
					</tr>
				</c:forEach>		
		</tbody>
	</table>
