...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 检索功能<span class="c-gray en">&gt;</span> 缺勤汇总表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		    <c:forEach items="${absenceList }" var="al">
				<tr class="text-c">		
					<td><input name="" type="checkbox" value="${al.abId }"></td>
					<td>${al.abName }</td>
					<td>${al.teammapping[0].tmmName }</td>
					<td>${al.abTime }</td>								
				</tr>
			</c:forEach>
		</tbody>
