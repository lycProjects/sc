...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="product_add('添加','adapt-teacher-add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span> </div>	
				...
				<tbody>
				    <c:forEach items="${teacherList }" var="tl">
				       <tr class="text-c va-m">
				          <input name="teId" type="hidden" value="${tl.teId}">
				          <td><input name="teId" type="checkbox" value="${tl.teId}"></td>
						  <td>${tl.teName}</td>
						  <td>${tl.teUnit}</td>
						  <td>${tl.tePhone}</td>	
						  <td>${tl.tePosition}</td>	
						  <td>${tl.teIdcard}</td>
						  <td class="td-manage"> 
						     <a style="text-decoration:none" class="ml-5" onClick="product_edit('修改信息','adapt-teacher-add.jsp','10001')" href="javascript:;" title="修改">
						        <a style="text-decoration:none" href="javascript:;" onClick="member_huanyuan(this,'1')" title="删除"><button class="btn btn-mini btn-danger" type="submit" >删除</button></a>&nbsp;&nbsp;
						        <a style="text-decoration:none" href="javascript:;" onclick="product_add('修改','updateteacher/${tl.teId}')" title="修改"><button class="btn btn-mini btn-danger" type="button" >修改</button></a>&nbsp;&nbsp;
						     </a>
						  </td>
				       </tr>
				    </c:forEach>
