...
<link href="${pageContext.request.contextPath}/style/static/h-ui.admin/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<section class="container-fluid page-404 minWP text-c">
	...
	<p class="error-description">不好意思，该功能正在开发中~</p>
