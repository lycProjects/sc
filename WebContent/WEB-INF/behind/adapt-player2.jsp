...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 团队成员管理 <span class="c-gray en">&gt;</span> 成员调整<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<div class="text-c" style="font-size: 24px;color: #18A628;"> 
		<form id="madaptForm" action="adapt" method="POST">
		
          </form>
	    </div>
	
	<!-- <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="product_add('添加','adapt-player-add.jsp')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span></div> -->
	<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
				     ...
				     <c:forEach items="${studentlist }" var="stl">
				       <tr class="text-c va-m">
						<td><input name="" type="checkbox" value="${stl.stId }"></td>
						<td>${stl.stNumber}</td>
						<td>${stl.stName}</td>
						<td>${stl.stClass}</td>
						<td>${stl.stTeacher}</td>	
						<td>${stl.stPhone}</td>	
					<!-- 	<td class="td-manage"> <a style="text-decoration:none" class="ml-5" onClick="product_edit('修改信息','adapt-player-add.jsp','10001')" href="javascript:;" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td> -->
					   </tr>
				    </c:forEach>
				</tbody>
			</table>
