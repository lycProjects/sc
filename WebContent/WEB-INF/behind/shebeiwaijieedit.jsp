...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/edit" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<!-- <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>借用团队：</label> -->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${equipborrow.eqbId}" placeholder="" id="" name="eqbId">
			</div>
		</div>
		...
		<div class="row cl">
			<!-- <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>借用团队：</label> -->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${equipborrow.eqbTeam}" placeholder="" id="" name="eqbTeam">
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">设备型号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${equipborrow.eqbZfour}" placeholder="" id="" name="eqbZfour">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">1G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${equipborrow.eqbOneg}" placeholder="" id="" name="eqbOneg">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">2G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${equipborrow.eqbTwog}" placeholder="" id="" name="eqbTwog">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">4G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${equipborrow.eqbFourg}" placeholder="" id="" name="eqbFourg">
			</div>
		</div>
