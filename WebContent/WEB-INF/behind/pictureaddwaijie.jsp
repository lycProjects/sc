...
<div class="page-container">
	<form  action="pictueraddwaijie" class="form form-horizontal" id="form-article-add" method="POST">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>团队名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <input type="text" class="input-text" value="" placeholder="" id="" name=""> -->
				<input type="text" name="eqbTeam" id="eqbTeam-input">
				<select name="eqbTeam" class="input-text" id="eqbTeam-select">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>Z400台数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="eqbZfour" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>1G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="eqbOneg" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>2G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="eqbTwog" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>4G内存条：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="eqbFourg" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
