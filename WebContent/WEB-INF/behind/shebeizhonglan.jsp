...
<body>
	<form action="deleteMany" >
		<nav class="breadcrumb"> <i class="Hui-iconfont">&#xe67f;</i> 首页
		<span class="c-gray en">&gt;</span> 双创设备管理 <span class="c-gray en">&gt;</span>
		设备总览 <a class="btn btn-success radius r"
		...
		<div class="page-container">
			<!-- <div class="text-c">
				...
				<input type="text" name="" id="" placeholder=" 设备名称"
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
						...
						<a  id="close-a" class="btn btn-primary radius" onclick="picture_add('添加设备','add-shebei')"  href="javascript:;">
			...
			<div class="mt-20">
				<table
					...
					<tbody>
						<c:forEach items="${equipLists }" var="equip">
							<tr class="text-c">
								<td><input name="ids" type="checkbox" value="${equip.id}"></td>
								<td>${equip.eqName}</td>
								<td>${equip.eqUnit}</td>
								<td>${equip.eqAmout}</td>
								<td>${equip.eqNote}</td>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/style/lib/My97DatePicker/4.8/WdatePicker.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/style/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/style/lib/laypage/1.2/laypage.js"></script>
